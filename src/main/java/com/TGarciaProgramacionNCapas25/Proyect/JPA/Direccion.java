...
public class Direccion {
    ...
    public Direccion(com.TGarciaProgramacionNCapas25.Proyect.ML.Usuario usuarioML){
        
        com.TGarciaProgramacionNCapas25.Proyect.ML.Direccion direccionML = usuarioML.Direcciones.get(0);
