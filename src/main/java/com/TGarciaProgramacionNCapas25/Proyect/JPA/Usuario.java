...
public class Usuario {
    ...
    public Usuario(com.TGarciaProgramacionNCapas25.Proyect.ML.Usuario usuarioML){
        ...
        if(usuarioML.Direcciones.get(0).getIdDireccion() == -1){
            ...
            for (com.TGarciaProgramacionNCapas25.Proyect.ML.Direccion Direction : usuarioML.Direcciones ){
