...
public class Usuario {
    ...
    public Usuario(com.TGarciaProgramacionNCapas25.Proyect.JPA.Usuario usuarioJPA){
        ...
        if(usuarioJPA.Direcciones !=null && usuarioJPA.Direcciones.size()>0){
            ...
            for(com.TGarciaProgramacionNCapas25.Proyect.JPA.Direccion Direction : usuarioJPA.Direcciones){
