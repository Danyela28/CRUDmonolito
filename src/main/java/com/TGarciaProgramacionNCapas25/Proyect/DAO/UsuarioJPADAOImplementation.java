...
public class UsuarioJPADAOImplementation implements IUsuarioJPADAO {
    ...
    public Result GetAll() {
        ...
        try {
            ...
            for (Usuario usuario : usuarios) {
                result.objects.add(new com.TGarciaProgramacionNCapas25.Proyect.ML.Usuario(usuario));
            }
    ...
    @Transactional
    @Override
    public Result Add(com.TGarciaProgramacionNCapas25.Proyect.ML.Usuario usuarioML) {
        Result result = new Result();
